...
DefaultProperties
{
	...
	NewPrimaryWeapons(9)=(CWeapon=class'SlumpModWeapon_Rapier',CorrespondingDuelProp=EDUEL_RapierUse)
	NewPrimaryWeapons(10)=(CWeapon=class'SlumpModWeapon_TBH',CorrespondingDuelProp=EDUEL_TBHUse)
