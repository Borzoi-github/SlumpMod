...
DefaultProperties
{
	...
	NewPrimaryWeapons(9)=(CWeapon=class'SlumpModWeapon_Nodachi',CorrespondingDuelProp=EDUEL_Nadochi)
	NewPrimaryWeapons(10)=(CWeapon=class'SlumpModWeapon_Bigsword',CorrespondingDuelProp=EDUEL_Bigsword)
