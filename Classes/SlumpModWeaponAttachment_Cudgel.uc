...
KickOffset=(X=50, Y=0, Z=-65)
	...
	AttackTypeInfo(1)=(fBaseDamage=55.0, fForce=10000, cDamageType="AOC.AOCDmgType_Blunt", iWorldHitLenience=6)
	AttackTypeInfo(2)=(fBaseDamage=20.0, fForce=9200, cDamageType="AOC.AOCDmgType_Blunt", iWorldHitLenience=6)
	AttackTypeInfo(3)=(fBaseDamage=100.0, fForce=34000, cDamageType="AOC.AOCDmgType_Blunt", iWorldHitLenience=6)
