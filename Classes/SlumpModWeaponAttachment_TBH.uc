...
*/
class SlumpModWeaponAttachment_TBH extends AOCWeaponAttachment_MorningStar;
...
KickOffset=(X=50, Y=0, Z=-65)
	...
	Begin Object Name=SkeletalMeshComponent0
		SkeletalMesh=SkeletalMesh'TBH.WEP_TBH'
	End Object
	...
	WeaponClass=class'SlumpModWeapon_TBH'

	WeaponSocket=wep1hpoint
	WeaponStaticMeshScale=1

	AttackTypeInfo(0)=(fBaseDamage=88.0, fForce=16400, cDamageType="AOC.AOCDmgType_PierceBlunt", iWorldHitLenience=6)
	AttackTypeInfo(1)=(fBaseDamage=90.0, fForce=18000, cDamageType="AOC.AOCDmgType_PierceBlunt", iWorldHitLenience=6)
	...
	Skins(0)={(
		SkeletalMeshPath="TBH.WEP_TBH",
		StaticMeshPath="TBH.Mesh_TBH",
		MaterialPath="",
		StaticMeshScale=1.0,
