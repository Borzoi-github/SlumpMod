...
*/
class SlumpModWeapon_BeardedSword extends AOCWeapon_Longsword;
...
DefaultProperties
{
	...
	AttachmentClass=class'SlumpModWeaponAttachment_BeardedSword'
	...
	AlternativeMode=class'SlumpModWeapon_Bearded'
