...
DefaultProperties
{
	...
	ConfigProjectileBaseDamage[5]=(Damage=32,InitialSpeed=3700.0,MaxSpeed=3700.0,AmmoCount=1,InitialGravityScale=0.95,Drag=0.000003,PitchCorrection=200)
	...
	WindupAnimations(0)=(AnimationName=3p_throwingknife_downtoup,ComboAnimation=,AssociatedSoundCue=SoundCue'A_Combat_Locomotion.shortsword_windup',bFullBody=False,bCombo=False,bLoop=False,bForce=false,fModifiedMovement=1.0,fAnimationLength=0.75,fBlendInTime=0.00,fBlendOutTime=0.00,bLastAnimation=false)
